import socket, threading, sys, datetime, atexit
...
def accept_connections():
    while True:
        ...
        threading.Thread(target=handle_connection, args=(new_client,), daemon=True).start()
        # Spin off connection in its own thread (set as daemon so it closes with mainthread)
